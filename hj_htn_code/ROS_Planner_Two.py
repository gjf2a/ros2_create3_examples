...
def main(args=None, namespace=''):
    ...
    planner.declare_operators(Planner.move, Planner.spin)
    planner.declare_methods(Planner.navigate, Planner.spin_at_location)
    all_plans = (planner.anyhop(state, [('spin_at_location','robot1', 'A'), ('spin_at_location', 'robot1', 'D'), ('spin_at_location', 'robot1', 'F')]))
