# From https://github.com/paccionesawyer/Create3_ROS2_Intro/blob/main/individual_examples/pub_LED.py
...
class LEDPublisher(Node):
    ...
    def timer_callback(self):
        ...
        led_colors = [random.choice(list(self.cp.__dict__.values())) for i in range(6)]
...
def main(args=None):
    ...
    led_publisher = LEDPublisher("archangel")
